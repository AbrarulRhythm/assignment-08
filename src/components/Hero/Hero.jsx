        ...
        <section className='hero-section pt-[87px]'>
            <div className='pt-10 lg:pt-20 text-center'>
                <div className='container'>
                    <h1 className='text-[42px] md:text-6xl lg:text-7xl text-heading font-bold leading-[1.2] mb-4'>We Build <br /> <span className='linear-gradient-1'>Productive</span> Apps</h1>
